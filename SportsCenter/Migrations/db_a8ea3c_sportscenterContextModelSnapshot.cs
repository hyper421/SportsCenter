...
{
    [DbContext(typeof(db_a8ea3c_sportscenterContext))]
    partial class db_a8ea3c_sportscenterContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportsCenter.Models.Entity.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportsCenter.Models.Entity.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportsCenter.Models.Entity.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportsCenter.Models.Entity.LocationBranch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportsCenter.Models.Entity.LocationImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportsCenter.Models.Entity.LocationOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportsCenter.Models.Entity.Member", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportsCenter.Models.Entity.Products", b =>
                {
            ...
            modelBuilder.Entity("SportsCenter.Models.Entity.ProductsCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportsCenter.Models.Entity.ProductsOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportsCenter.Models.Entity.ProductsOrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportsCenter.Models.Entity.LocationBranch", b =>
                {
                    b.HasOne("SportsCenter.Models.Entity.Category", "Category")
                        .WithMany("LocationBranch")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SportsCenter.Models.Entity.Location", "Location")
                        .WithMany("LocationBranch")
            ...
            modelBuilder.Entity("SportsCenter.Models.Entity.LocationOrder", b =>
                {
                    b.HasOne("SportsCenter.Models.Entity.Location", "LocationBranch")
                        .WithMany("LocationOrder")
                        .HasForeignKey("LocationBranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SportsCenter.Models.Entity.LocationBranch", "LocationBranchId1Navigation")
                        .WithMany("LocationOrder")
                        .HasForeignKey("LocationBranchId1");

                    b.HasOne("SportsCenter.Models.Entity.Member", "Member")
                        .WithMany("LocationOrder")
            ...
            modelBuilder.Entity("SportsCenter.Models.Entity.Products", b =>
                {
                    b.HasOne("SportsCenter.Models.Entity.Item", "Item")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("SportsCenter.Models.Entity.ProductsCart", b =>
                {
                    ...
                    b.HasOne("SportsCenter.Models.Entity.Products", "Products")
                        .WithMany("ProductsCart")
            ...
            modelBuilder.Entity("SportsCenter.Models.Entity.ProductsOrderDetail", b =>
                {
                    b.HasOne("SportsCenter.Models.Entity.ProductsOrder", "ProductOrder")
