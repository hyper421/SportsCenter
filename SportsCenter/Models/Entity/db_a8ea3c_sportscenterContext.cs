...
{
    public partial class db_a8ea3c_sportscenterContext : DbContext
    {
        public db_a8ea3c_sportscenterContext()
        {
        }

        public db_a8ea3c_sportscenterContext(DbContextOptions<db_a8ea3c_sportscenterContext> options)
            : base(options)
        {
        }
